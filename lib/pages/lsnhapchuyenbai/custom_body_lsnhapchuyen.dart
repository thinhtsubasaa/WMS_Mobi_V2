...
class _BodyLSNhapChuyenScreenState extends State<BodyLSNhapChuyenScreen> with TickerProviderStateMixin, ChangeNotifier {
  ...
  Future<void> getLSNhap(String? tuNgay, String? denNgay, String? KhoXe_Id, String? BaiXe_Id, String? DongXe_Id, String? keyword) async {
    _dn = [];
    try {
      final http.Response response = await requestHelper.getData('KhoThanhPham/GetDanhSachXeDieuChuyenAll?TuNgay=$tuNgay&DenNgay=$denNgay&KhoXe_Id=$KhoXe_Id&BaiXe_Id=$BaiXe_Id&DongXe_Id=$DongXe_Id&keyword=$keyword');
