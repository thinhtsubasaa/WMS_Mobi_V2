...
class HuyDongSealBloc extends ChangeNotifier {
  ...
  Future<void> getData(BuildContext context, String qrcode) async {
    ...
    _dongcont = null;
    try {
      final http.Response response = await requestHelper.getData('DSX_DongCont/GetSoKhungHuyDongSealmobi?SoKhung=$qrcode');
